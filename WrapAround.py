...
class Dastan:
    ...
    def __DisplayMoves(self, CurrentPlayer, Choice, StartSquareReference):
        print("\n" + "   ", end="")
        ...
        for Row in range(1, self._NoOfRows + 1):
            ...
            for Column in range(1, self._NoOfColumns + 1):
                ...
                if self.__CheckSquareIsValid(Row * 10 + Column, False) and CurrentPlayer.CheckPlayerMove(Choice, StartSquareReference, Row * 10 + Column, self._NoOfColumns):
                    print("^", end="")
    ...
    def PlayGame(self):
        ...
        while not GameOver:
            ...
            SquareIsValid = False
            self.__DisplayMoves(self._CurrentPlayer,Choice,StartSquareReference)
            while not SquareIsValid:
            ...
            MoveLegal = self._CurrentPlayer.CheckPlayerMove(Choice, StartSquareReference, FinishSquareReference, self._NoOfColumns)
            if MoveLegal:
...
class MoveOption:
    ...
    def CheckIfThereIsAMoveToSquare(self, StartSquareReference, FinishSquareReference, columnNumber):
        ...
        if FinishColumn > columnNumber:
            FinishColumn = FinishColumn % columnNumber
        elif FinishColumn == 0:
            FinishColumn += columnNumber
...
class Player:
    ...
    def CheckPlayerMove(self, Pos, StartSquareReference, FinishSquareReference, ColumnNumber):
        Temp = self.__Queue.GetMoveOptionInPosition(Pos - 1)
        return Temp.CheckIfThereIsAMoveToSquare(StartSquareReference, FinishSquareReference, ColumnNumber)
