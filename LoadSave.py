    ...
    def __DisplayBoard(self):
        ...
        for Row in range(1, self._NoOfRows + 1):
            ...
            for Column in range(1, self._NoOfColumns + 1):
                ...
                #print(PieceInSquare)
                if PieceInSquare is None or PieceInSquare == '':
                    print(" ", end="")
                else:
        ...
        for row in range(1, self._NoOfRows+1):
            for col in range(1, self._NoOfColumns+1):
                ...
                if Piece == None:
                    ...
                    GameState.append(self._Board[Index].GetPieceInSquare().GetSymbol())
        ...
        with open(file, 'r') as TextFile:
            ...
            for PieceIndex in range(0, len(LoadFile)):
                ...
                if LoadFile[PieceIndex] == 'N':
                    ...
                    self._Board[PieceIndex].SetPiece(CurrentPiece)
                elif LoadFile[PieceIndex] == '1':
                    CurrentPiece = Piece("mirza", self._Players[0], 5, '1')
                    self._Board[PieceIndex].SetPiece(CurrentPiece)
                elif LoadFile[PieceIndex] == '"':
                    CurrentPiece = Piece("piece", self._Players[1], 1, '"')
                    self._Board[PieceIndex].SetPiece(CurrentPiece)
                elif LoadFile[PieceIndex] == '2':
    ...
    def PlayGame(self):
        ...
        while not GameOver:
            ...
            while Choice < 1 or Choice > 3:
                Choice = int(input("Choose move option to use from queue (1 to 3), 7 to Save, 8 to Load and 9 to take the offer: "))
                if Choice == 9:
