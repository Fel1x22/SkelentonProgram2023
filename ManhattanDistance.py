...
class Dastan:
    ...
    def __ManhattanDistance(self, startSquare, finishSquare):
        horizontalDistance = abs((startSquare % 10) - (finishSquare % 10))
        verticalDistance = abs((startSquare // 10) - (finishSquare // 10))
    ...
    def PlayGame(self):
        ...
        while not GameOver:
            ...
            if MoveLegal:
                ManhatDistance = self.__ManhattanDistance(StartSquareReference, FinishSquareReference)
                print("Manhattan distance covered: " + str(ManhatDistance))
